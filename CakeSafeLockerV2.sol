...
contract CakeSafeLockerV2 is Ownable, ReentrancyGuard {
   ...
   * @param _fee_in_bnb fees can be paid in bnb or in a secondary token such as SAFE with a discount on cake-lp tokens
