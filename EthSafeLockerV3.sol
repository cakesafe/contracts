...
contract EthSafeLockerV3 is Ownable, ReentrancyGuard {
  ...
  constructor(IUniswapV3Factory _uniswapV3Factory) public {
    devaddr = msg.sender;
  ...
  function lockLPToken (address _lpToken, uint256 _amount, uint256 _unlock_date, address payable _referral, bool _fee_in_eth, address payable _withdrawer) external payable nonReentrant {
    ...
    IUniswapV3Pair lpair = IUniswapV3Pair(address(_lpToken));
    address factoryPairAddress = uniswapV3Factory.getPair(lpair.token0(), lpair.token1());
